...
function init() {
  ...
  const marbleUniforms = {
    ...
    swirlIntensity: {
      value: params.swirlIntensity
    },
    swirlFrequency: {
      value: params.swirlFrequency
    },
    transparency: {
      value: params.transparency
    },
    refractionIntensity: {
      value: params.refractionIntensity
    },
    glossiness: {
      value: params.glossiness
    },
    mainLightIntensity: {
      value: params.mainLightIntensity
    },
    ambientLightIntensity: {
      value: params.ambientLightIntensity
    },
    ambientLightColor: {
      value: new THREE.Color(params.ambientLightColor)
    },
    directionalLightColor: {
      value: new THREE.Color(params.directionalLightColor)
    },
    secondaryLightColor: {
      value: new THREE.Color(params.secondaryLightColor)
    },
    secondaryLightIntensity: {
      value: params.secondaryLightIntensity
    },
    time: {
      value: 0
    },
    ...
    displacementStrength: {
      value: params.displacementStrength
    },
    lineScale: {
      value: params.lineScale
    },
    lineIntensity: {
